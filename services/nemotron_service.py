...
class NemotronService:
    ...
    def analyze_signal(self, symbol: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "even implicitly.\n"
            "- Do NOT add trading advice or recommendations.\n"
            "- If 'is_stale' is true, or if 'last_tick_timestamp' is older than 60 seconds, or if any required fields "
            "(ltp, bid, ask, volume) are missing, you MUST set the output JSON 'confidence' field to null and the "
            "'prediction_basis' field to 'stale_data' — do not guess a percentage.\n"
            "- Only assign a numeric confidence percentage (0-100) and set 'prediction_basis' to 'fresh_data' when "
            "all inputs are present and fresh (is_stale is false).\n"
            "- Base your explanation only on the data provided to you. Do not fabricate indicators or news.\n"
            "\n"
            "OUTPUT FORMAT:\n"
            ...
            '  "supporting_factors": ["array of concise points supporting the decision"],\n'
            '  "risk_factors": ["array of concise risks or opposing indicators"],\n'
            '  "reasoning": "2-3 paragraphs explaining the market context.",\n'
            '  "confidence": null or a number between 0 and 100,\n'
            '  "prediction_basis": "stale_data" or "fresh_data"\n'
            "}"
        )
        ...
        try:
            ...
            if json_match:
                ...
                return {
                    ...
                    "prediction_basis": parsed.get("prediction_basis") or "unknown"
                }
            else:
